...
//        );
        ...
        scene.addGeometries(
                new Sphere(new Color(255, 242, 0), new Material(0.4, 0.3, 100, 0.8, 0),
                ...
                new Triangle(new Color(149, 98, 68), new Material(0.8, 1, 10000, 0, 1),
                        new Point3D(-153, -107, 0), new Point3D(153, -107, 0), new Point3D(0, 205, 0)),
                new Triangle(new Color(149, 98, 68), new Material(0.8, 1, 10000, 0, 1),
                        new Point3D(-153, -107, 0), new Point3D(0, -107, -255), new Point3D(0, 205, 0)),
                new Triangle(new Color(149, 98, 68), new Material(0.8, 1, 10000, 0, 1),
                        new Point3D(153, -107, 0), new Point3D(0, -107, -255), new Point3D(0, 205, 0)),
        ...
        ImageWriter imageWriter = new ImageWriter("superSamplingIceCreamTestSide", 1000, 1000, 1000, 1000);
