...
public class SuperSamplingTest {
    ...
    // look from up
    @Test
    public void MultiGeometriesWithSuperSamplingUp() {
        scene.set_camera(
                new Camera(
        ...
        ImageWriter imageWriter = new ImageWriter(
                "superSamplingIceCreamTestUp", 1000, 1000, 1000, 1000);
    ...
    //look from side
    @Test
    public void MultiGeometriesWithSuperSamplingSide() {
        scene.set_camera(
                new Camera(
        ...
        ImageWriter imageWriter = new ImageWriter(
                "superSamplingIceCreamTestSide", 1000, 1000, 1000, 1000);
        Render render = new Render(imageWriter, scene);
        render.set_superSampling(1d);
        render.set_rayNumber(50);
        render.renderImage();
